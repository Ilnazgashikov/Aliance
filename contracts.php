...
<section class="section seo">
    <div class="container">
        ...
        <picture>
            <source type="image/webp" srcset="img/load.webp" >
            <source type="image/png" srcset="img/load.png">
            <img src="img/load.png" alt="Загрзука">
        </picture>
        <a href="#" class="seo-button-link">Читать больше</a>
        </div>
    </div>
</section>
